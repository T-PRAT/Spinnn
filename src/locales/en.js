...
export default {
	...
	workout: {
		...
		stopConfirmMessage:
			"Are you sure you want to stop this session? Your data will be saved.",
		...
		currentOffset: "Interval adjustment",
		globalOffset: "Global adjustment",
	},
	metrics: {
		power: "Power",
		heartRate: "HR",
	...
	settings: {
		...
		audio: {
			...
			description:
				"Choose a sound to play at the beginning of each new interval during your workout",
			test: "Test",
			sounds: {
				none: "None",
		...
		athlete: {
			...
			ftpTooltip:
				"FTP is the maximum power you can maintain for about an hour. It is used to calculate your training zones and TSS.",
			ftpUnit: "watts",
		...
		intervals: {
			...
			apiKeyHint:
				"Generate an API key in your Intervals.icu developer settings",
